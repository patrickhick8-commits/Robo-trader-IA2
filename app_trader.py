    ...
    if uploaded_file is not None:
        ...
        if st.button("🚀 EXECUTAR ANÁLISE COMPLETA"):
            with st.spinner("IA escaneando padrões de velas, volume e mercado..."):
                ...
                # Prompt atualizado para fundir volume oculto, médias, lta/ltb, s/r e padrões visuais
                prompt = """
                ...
                Sua missão é analisar minuciosamente a imagem enviada com foco absoluto na anatomia das velas, cruzamento de indicadores e métricas estruturais do mercado para projetar um clique de 2 a 5 minutos no futuro com expiração para a mesma vela.

                Analise rigorosamente as seguintes variáveis visuais e confluências na imagem:
                1. ANATOMIA DAS VELAS E VOLUME IMPLÍCITO: Deduza o Volume de Negociação baseado no tamanho dos corpos das velas (corpos expandidos/Marubozu = alto volume; corpos espremidos/Dojis = baixo volume) e rejeição/absorção por pavios longos.
                2. PROJEÇÃO DE INDICADORES INTERNOS: 
                ...
                3. ZONEAMENTO ESTRUTURAL (S/R e LTA/LTB): Identifique zonas horizontais de Suporte e Resistência, e linhas de tendência inclinadas (LTA / LTB) traçadas pelos fundos e topos do print.
                4. PADRÕES GRÁFICOS VISUAIS: Identifique estruturas macro como OCO (Ombro-Cabeça-Ombro), Topo/Fundo Duplo, Triângulos de afunilamento, Canais ou Caixas de Acumulação.
                5. VALIDAÇÃO DE PADRÕES DE CANDLES (VELAS):
                ...
                - Para emitir um sinal válido, exija confluência (Ex: Toque em LTA + Candle Martelo + RSI Sobrevendido).
                - Se as médias EMA 9 e SMA 20 estiverem emboladas, horizontais e sem volume claro, retorne "OPERAÇÃO ABORTADA".
                ...
                - Filtro de Proteção Ativado: [Justificativa do porquê o sinal passou no teste de segurança e não foi abortado]

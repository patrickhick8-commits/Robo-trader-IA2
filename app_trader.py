...
# 3. Interface Principal de Inputs (AGORA 100% AUTOMÁTICA)
...
# 4. Definição do Prompt Mestre com Escaneamento Visual Automático de Tempo e Preço
